						...
						<view class="flex flex-ac flex-jc">
							...
							<view class=" flex flex-dc" style="width: 340rpx; min-height: 100%; margin-left: 12rpx;">
								<view class=" cor-4 font-26 font-w7 text-d">
									<text v-if="item.goodsInfo.seckill" class=" font-24 font-w4 "
										style=" color: #fff; height: 32rpx; margin-right: 10rpx; border-radius: 6rpx; line-height: 24rpx; padding: 0 6rpx 2rpx 6rpx;  background: linear-gradient(135deg, #eb3c39 0%, #f93f3c 100%);  display: inline-flex; align-items: center; justify-content: center; min-height: 24rpx;">{{
											t('tips.seckill') }}</text>
									<text v-if="item.goodsInfo.qualityed" class=" font-24 font-w4 "
										style=" color: #fff; height: 32rpx; border-radius: 6rpx; line-height: 32rpx; padding: 0 6rpx 2rpx 6rpx;  background: linear-gradient(135deg, #6ccc4e 0%, #76dd54 100%);  display: inline-flex; align-items: center; justify-content: center; min-height: 24rpx;">{{
											t('tips.niceSelect') }}</text>
								...
								<view class=" flex flex-ac flex-jb cor-8 font-22" style="margin-top: 8rpx;">
									...
									<view @tap.stop="addGoodsInfo(item.goodsInfo)"
										class="pos-r bor-50- flex flex-ac flex-jc"
										...
										<view v-if="pageGoodsNumberObj[item.goodsInfo.id]"
											class="aaa pos-a font-24 cor-f flex flex-ac flex-jc"
											style="background: #f43530; border-radius: 17rpx; right: -10rpx;top: -10rpx; width: 34rpx;height: 34rpx;">
